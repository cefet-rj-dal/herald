...
# Experiment function --------------------------------------------------------
run_exp <- function(data,id,lag_pred=0, mdl_train=30, online_step=1, pred_ic=FALSE, pred_par=NULL, pred_recursive=FALSE, 
  ...
  exp_res <- cbind(id=id,lag=lag_pred,mdl=mdl_train,ic=pred_ic,par=ifelse(pred_ic,pred_par[[1]],NA),
