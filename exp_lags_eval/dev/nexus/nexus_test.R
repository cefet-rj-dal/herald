...
online_detector_full <- nexus(datasource, har_arima(), warm_size = 30, batch_size = 15, mem_batches = 0)
...
online_detector <- nexus(datasource, har_arima(), warm_size = 30, batch_size = 30, mem_batches = 0)
